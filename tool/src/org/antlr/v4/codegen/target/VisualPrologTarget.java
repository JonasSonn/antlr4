...
public class VisualPrologTarget extends Target {
	protected static final String[] visualPrologKeywords = {
	...
	public VisualPrologTarget(CodeGenerator gen) {
		super(gen, "VisualProlog");
	}
	...
	protected STGroup loadTemplates() {
		...
		result.registerRenderer(String.class, new visualPrologRenderer(), true);
		return result;
	}

	protected static class visualPrologRenderer extends StringRenderer {
	...
	protected void addBadWords() {
		badWords.addAll(Arrays.asList(visualPrologKeywords));
		badWords.add("rule");
